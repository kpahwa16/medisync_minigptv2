...
from medisync.conversation.conversation import Conversation, SeparatorStyle, Chat
...
vis_processor_cfg = cfg.datasets_cfg.slake_grounded_caption.vis_processor.train
...
title = """<h1 align="center">MediSync Demo</h1>"""
